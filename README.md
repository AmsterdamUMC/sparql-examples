...
This is a collection of SPARQL examples usable on different Amsterdam UMC related SPARQL endpoints or datasets. The examples are stored one query per file in project specific repositories in the [examples](https://github.com/AmsterdamUMC/sparql-examples/tree/master/examples) folder.
